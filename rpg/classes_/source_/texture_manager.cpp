...
SDL_Texture* TextureManager::loadTexture(const std::string& path) noexcept
{
...
TextureAsset TextureManager::makeTextureAsset(const std::string& path) noexcept
{
...
void TextureManager::loadUITextures() noexcept
{
...
void TextureManager::loadFloorTextures() noexcept
{
